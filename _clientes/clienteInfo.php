...
<body>
    <div class="aligntbl">
        ...
        require '../conexao.php';
        $sql = "select * from tbl_cliente, tbl_cidade where tbl_usuario_usu_codigo = $usu_codigo and tbl_cidade_cid_codigo=cid_codigo";
        ...
        while ($linha_do_banco = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td colspan='4'> <a href='../_pedidos/clientePedido.php'> Seus Pedidos</a></td>";
            echo "<tr>";
